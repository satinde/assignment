...
const Sign = () => {
  ...
  return (
    <>
       <div className='signup' style={{ backgroundImage: `url(${bg.src})`, width: '100%', height: '100vh',backgroundPosition: 'center', backgroundSize:'cover'}}>
          <div className='signup-left' style={{ backgroundImage: `url(${bg2.src})` }}>
                <div className="content">
                    <p>Already have an account?</p>
                    <Link href={"/LogIn"} className="btn">Log In</Link>
                </div>
          </div>
          <div className='signup-righ' style={{ backgroundImage: `url(${bg2.src})` }}>
